      ...
      <div class="card-body p-1">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-4">
            ...
            <a class="btn btn-danger btn-adicionar" data-bs-toggle="modal" data-bs-target="#carrinhoModal" data-titulo="Açaí Tam. P" data-descricao="300g de açaí" data-preco="R$ 15,00">+</a>
          </div>
        </div>
      </div>
    </div>
    <div class="card m-1" style="width: 100%;">
      ...
      <div class="card-body p-1">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-4">
            <!-- Adicione um atributo para identificar o botão de adicionar ao carrinho -->
            <a class="btn btn-danger btn-adicionar" data-bs-toggle="modal" data-bs-target="#carrinhoModal" data-titulo="Açaí Tam. M" data-descricao="400g de açaí" data-preco="R$ 20,00">+</a>
          </div>
        </div>
      </div>
    </div>
